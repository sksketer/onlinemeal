                ...
                <ul class="nav-links">
                    ...
                    <li>
                        <div class="sign-btn logout" style="color: red;">
                            '.$fname.'-'.$lname.'<button class="logout-btn" onclick="show_logout()">
                                        v
                                      </button>
                ...
                <div class="_containt" id="_containt">
                    ...
                    <div class="services" id="services">
                        ...
                        <div class="services-card">
                            ...
                            <div class="card">
                                <a href="pages/snacks.php"><img src="../img/card/snacks-card.jpg" alt="Image Not Found">
                                    <h2 class="card-text">Snacks</h2>
                                </a>
                            </div>
                            <div class="card">
                                <a href="pages/dinner.php"><img src="../img/card/dinner-card.jpg" alt="Image Not Found">
